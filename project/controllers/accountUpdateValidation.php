...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if ($flag) {
		...
		header("Location:../views/accountUpdate.php");
	}

// 	$updatedData = getUpdatedData($id);
...
// 	exit();
// } else {
// 	// ... (your existing code for handling validation errors)
// }


// function getUpdatedData($id) {
// $con = Connection();
// $stmt = $con->prepare("SELECT firstName, lastName, dob, email, phoneNumber, gender, bloodGroup, securityQuestion, id FROM patient WHERE id = ?");
