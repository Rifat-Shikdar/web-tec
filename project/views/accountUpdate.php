...
<head>
    ...
    <title>Form</title>
    <script src="../views/js/accountUpdate.js"></script>
    <link rel="stylesheet" href="../views/css/accountUpdate.css">
</head>
...
<body>
    ...
    <form  action="../controllers/accountUpdateValidation.php" id="updateForm" method="post" novalidate onsubmit="return isValid(this);">
        <table>
            ...
            <td>
                ...
                <button class="btn hover"><a class="btn-link" href="../views/patientProfile.php"> Back</a></button>
        </table>
    </form>
