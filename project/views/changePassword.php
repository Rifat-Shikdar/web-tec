...
<head>
    ...
    <script src="../views/js/changePassword.js"></script>
</head>
<body>
<?php
...
<div class="nav">
    ...
    <form action="../controllers/validationChangePassword.php" method= "post" novalidate onsubmit="return isValid(this);">
    ...
    <button class="btn hover"><a class="btn-link" href="../views/patientProfile.php">Go back</a></button>
</form>
