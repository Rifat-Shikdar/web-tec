...
<head>
    ...
    <link rel="stylesheet" href="../views/css/forgetPassword.css">
    <script src="../views/js/forgetPassword.js"></script>
...
<body>
    ...
    <div class="nav">
        ...
        <a href="">Index</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="">Contact Us </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button class="btn hover"><a class="btn-link" href="../views/logOut.php">Logout</a></button><br>
    </div>
    <form action="../controllers/forgetPasswordValidation.php" method="post" novalidate onsubmit="return isValid(this);">
        ...
        <button class="btn hover"><a class="btn-link" href="../views/login.php">Go back</a></button>
    </form>
