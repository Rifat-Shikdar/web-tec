...
<body>
    ...
    <form action="../controllers/loginValidation.php" method="post" novalidate id="form" onsubmit="return isValid(this);">
        ...
        <a  href="../views/forgetPassword.php" id="forget_password">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Forget Password ? </a>

       
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Do not have any Account ?</p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; For Sign up &nbsp;&nbsp;<button class="hover"><a class="btn_registration " href="../views/registration.php">Registration</a></button></p>
