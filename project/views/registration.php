...
<body>
  ...
  <form action="../controllers/registrationValidation.php" method="post" novalidate onsubmit="return isValid(this);">
    <table>
      ...
      <td>
        ...
        <button class="btn hover" ><a id="login_button" href="../views/login.php">Login</a></button>
