...
<head>
  ...
  <title>Form</title>
  <script src="../views/js/testReport.js"></script>
  <link rel="stylesheet" href="../views/css/testReport.css">
</head>
...
<div class="nav">
  ...
  <form action="../controllers/testReportValidation.php" method="post" novalidate onsubmit="return isValid(this);">
    <table>
      ...
      <td>
        ...
        <button class="btn hover"><a class="btn-link" href="../views/report.php">Go back</a></button>
        <button class="btn hover"><a class="btn-link" href="../views/patientProfile.php">Home</a></button>
    </table>
    </form>
</body>
