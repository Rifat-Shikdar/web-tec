...
<head>
  ...
  <link rel="stylesheet" href="../views/css/updateForgetPassword.css">
  <script src="../views/js/updateForgetPassword.js"></script>
...
<body>
  ...
  <form action="../controllers/updateForgetPasswordValidation.php" method="post" novalidate onsubmit="return isValid(this)";>
