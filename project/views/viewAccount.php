...
<head>
    ...
    <link rel="stylesheet" href="../views/css/viewAccount.css">
</head>
...
<body>
    ...
    <hr>
    <button class="btn hover"><a class="btn-link" href="../views/accountUpdate.php">Modify You Information</a></button>
    <button class="btn hover"><a class="btn-link" href="../views/patientProfile.php">Back</a></button><br><br>
